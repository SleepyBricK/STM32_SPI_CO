...
#define USBD_PRODUCT_STRING_HS           "STM32H743 ULPI HS Bulk"
#define USBD_SERIALNUMBER_STRING_HS      "ULPI00000001"
#define USBD_CONFIGURATION_STRING_HS     "ULPI Bulk Config"
#define USBD_INTERFACE_STRING_HS         "ULPI Vendor Bulk"
